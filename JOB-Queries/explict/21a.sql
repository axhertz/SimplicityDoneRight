...
join title AS t on (t.production_year BETWEEN 1950 AND 2000 AND t.id = mk.movie_id)
...
on(mi.movie_id = t_ml.linked_movie_id and mi.info IN ('Sweden', 'Norway', 'Germany', 'Denmark', 'Swedish','Denish', 'Norwegian', 'German'))